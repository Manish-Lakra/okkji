...
export default class NetworkManager {
    ...
    async fetchRequest(api, method, parameters = {}, onRetryClicked = null, serviceTimeOut = AppInfo.serviceTimeOut) {
        ...
        if (!this.isInternetConnected) {
            ...
            // if(shouldShowNoInternetMessage)
            //     Utility.sharedInstance.showToast({ message: 'Please check your internet connection' })
        ...
        let headers = {
            ...
            // 'Authorization': `Bearer ${Session.session.user.loginToken || ''}`
        };
        if (this.token != null) {
